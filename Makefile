...
raysession: src/ui_raysession.py src/ui_about_raysession.py src/ui_client_slot.py src/ui_kill_server.py src/ui_new_executable.py \
	src/ui_new_session.py src/ui_open_session.py src/ui_proxy_gui.py src/ui_quit_app.py src/ui_abort_session.py src/ui_error_dialog.py src/ui_proxy_copy.py src/ui_nsm_open_info.py
