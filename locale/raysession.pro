...
FORMS += ../resources/ui/client_advanced_properties.ui
...
FORMS += ../resources/ui/settings.ui
...
SOURCES += ../src/daemon/ray_daemon.py
SOURCES += ../src/daemon/scripter.py
SOURCES += ../src/daemon/session_operating.py
SOURCES += ../src/daemon/session_signaled.py
SOURCES += ../src/daemon/templates_database.py
SOURCES += ../src/gui/add_application_dialog.py
SOURCES += ../src/gui/child_dialogs.py
SOURCES += ../src/gui/client_prop_adv_dialog.py
...
SOURCES += ../src/gui/preferences_dialog.py
