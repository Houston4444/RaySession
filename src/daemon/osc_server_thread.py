...
from daemon_tools import (
    TemplateRoots, CommandLineArgs, RS, get_code_root)
...
METHODS_DICT = {
    ...
    r.server.patchbay.SAVE_GROUP_CUSTOM_NAME: 'sssi',
    r.server.patchbay.SAVE_PORT_CUSTOM_NAME: 'sssi',
...
class OscServerThread(ClientCommunicating):
    ...
    def _srv_ask_for_patchbay(self, osp: OscPack):
        patchbay_dmn_port = patchbay_dmn_mng.get_port()
    ...
    def announce_gui(
        ...
        self.send(gui.addr, rg.server.AUTO_EXPORT_CUSTOM_NAMES,
                  self.jack_export_naming.value)
