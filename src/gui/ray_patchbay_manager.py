...
class RayPatchbayManager(PatchbayManager):
    ...
    def refresh(self):
        super().refresh()
        self.send_to_patchbay_daemon(RP.REFRESH)
    ...
    def change_buffersize(self, buffer_size: int):
        ...
        self.send_to_patchbay_daemon(
            RP.SET_BUFFER_SIZE, buffer_size)
    ...
    def transport_play_pause(self, play: bool):
        self.send_to_patchbay_daemon(RP.TRANSPORT_PLAY, int(play))
    
    def transport_stop(self):
        self.send_to_patchbay_daemon(RP.TRANSPORT_STOP)
    
    def transport_relocate(self, frame: int):
        self.send_to_patchbay_daemon(RP.TRANSPORT_RELOCATE, frame)
