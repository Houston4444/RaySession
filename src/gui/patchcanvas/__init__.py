...
ACTION_PORT_GROUP_ADD = 6 # N, N, "gId:pgId:pMode:pType:portId1:portId2"
ACTION_PORT_GROUP_REMOVE = 7 # group_id, portgrp_id, N
ACTION_PORT_INFO = 8 # group_id, port_id, N
ACTION_PORT_RENAME = 9 # group_id, port_id, N
ACTION_PORTS_CONNECT = 10 # N, N, "outG:outP:inG:inP"
ACTION_PORTS_DISCONNECT = 11 # conn_id, N, N
ACTION_PLUGIN_CLONE = 12 # plugin_id, N, N
ACTION_PLUGIN_EDIT = 13 # plugin_id, N, N
ACTION_PLUGIN_RENAME = 14 # plugin_id, N, N
ACTION_PLUGIN_REPLACE = 15 # plugin_id, N, N
ACTION_PLUGIN_REMOVE = 16 # plugin_id, N, N
ACTION_PLUGIN_SHOW_UI = 17 # plugin_id, N, N
ACTION_BG_RIGHT_CLICK = 18 # N, N, N
ACTION_DOUBLE_CLICK = 19 # N, N, N
ACTION_INLINE_DISPLAY = 20 # plugin_id, N, N
