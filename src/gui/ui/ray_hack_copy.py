...
# Form implementation generated from reading ui file 'resources/ui/ray_hack_copy.ui'
#
...
class Ui_Dialog(object):
    ...
    def retranslateUi(self, Dialog):
        ...
        self.labelFileNotInFolder.setText(_translate("Dialog", "file is not in client working directory."))
        self.label.setText(_translate("Dialog", "<html><head/><body><p>Do you want to copy this file to client working directory or to use directly this file ?</p></body></html>"))
