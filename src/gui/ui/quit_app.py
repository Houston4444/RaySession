...
class Ui_DialogQuitApp(object):
    def setupUi(self, DialogQuitApp):
        ...
        self.pushButtonDaemon = QtWidgets.QPushButton(DialogQuitApp)
        icon = QtGui.QIcon.fromTheme("daemon")
        self.pushButtonDaemon.setIcon(icon)
        self.pushButtonDaemon.setObjectName("pushButtonDaemon")
        self.horizontalLayout.addWidget(self.pushButtonDaemon)
    ...
    def retranslateUi(self, DialogQuitApp):
        ...
        self.pushButtonDaemon.setText(_translate("DialogQuitApp", "Keep Daemon Running"))
