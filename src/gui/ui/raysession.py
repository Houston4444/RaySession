...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.frameCurrentSession = SessionFrame(self.MainFrame)
...
"QToolButton {border: none}")
        ...
        self.horizontalLayout_4.addWidget(self.frameCurrentSession)
        ...
        self.dockWidgetMessages.setMinimumSize(QtCore.QSize(280, 130))
        ...
        self.dockWidgetPatchBay = QtWidgets.QDockWidget(MainWindow)
        self.dockWidgetPatchBay.setObjectName("dockWidgetPatchBay")
        ...
        self.dockWidgetPatchBay.setWidget(self.dockWidgetContents)
        MainWindow.addDockWidget(QtCore.Qt.DockWidgetArea(2), self.dockWidgetPatchBay)
