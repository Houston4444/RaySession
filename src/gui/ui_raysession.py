...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.verticalLayout_4.setContentsMargins(0, 2, 0, 4)
        ...
        self.frameCurrentSession = SessionFrame(self.centralwidget)
        ...
        self.toolButtonDuplicateSession = QtWidgets.QToolButton(self.frameCurrentSession)
        self.toolButtonDuplicateSession.setStyleSheet("QToolButton{border: none}")
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/scalable/breeze/xml-node-duplicate.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.toolButtonDuplicateSession.setIcon(icon)
        self.toolButtonDuplicateSession.setIconSize(QtCore.QSize(22, 22))
        self.toolButtonDuplicateSession.setObjectName("toolButtonDuplicateSession")
        self.horizontalLayout_2.addWidget(self.toolButtonDuplicateSession)
        self.toolButtonSaveTemplateSession = QtWidgets.QToolButton(self.frameCurrentSession)
        self.toolButtonSaveTemplateSession.setStyleSheet("QToolButton{border: none}")
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/scalable/breeze/document-save-as-template.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.toolButtonSaveTemplateSession.setIcon(icon1)
        self.toolButtonSaveTemplateSession.setIconSize(QtCore.QSize(22, 22))
        self.toolButtonSaveTemplateSession.setObjectName("toolButtonSaveTemplateSession")
        self.horizontalLayout_2.addWidget(self.toolButtonSaveTemplateSession)
...
"QToolButton {border: none}")
        ...
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/scalable/breeze/document-save.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.toolButtonSaveSession.setIcon(icon2)
...
"QToolButton {border: none}")
        ...
        self.verticalLayout_3.addWidget(self.frameCurrentSession)
        ...
        self.textEditMessages.setStyleSheet("QPlainTextEdit { font-size: 12px}")
        ...
        self.menuBar.setGeometry(QtCore.QRect(0, 0, 413, 30))
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/48x48/raysession.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.actionAboutRaySession.setIcon(icon3)
        ...
        icon4.addPixmap(QtGui.QPixmap(":/scalable/breeze/disabled/window-close.svg"), QtGui.QIcon.Disabled, QtGui.QIcon.Off)
        self.actionCloseSession.setIcon(icon4)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/scalable/breeze/list-remove.svg"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        icon5.addPixmap(QtGui.QPixmap(":/scalable/breeze/disabled/list-remove.svg"), QtGui.QIcon.Disabled, QtGui.QIcon.Off)
        icon5.addPixmap(QtGui.QPixmap(":/scalable/breeze/list-remove.svg"), QtGui.QIcon.Selected, QtGui.QIcon.Off)
        self.actionAbortSession.setIcon(icon5)
        ...
        self.actionDuplicateSession.setIcon(icon)
        ...
        self.actionSaveAllFromSavedClient = QtWidgets.QAction(MainWindow)
        self.actionSaveAllFromSavedClient.setCheckable(True)
        self.actionSaveAllFromSavedClient.setChecked(True)
        icon = QtGui.QIcon.fromTheme("document-save-all")
        self.actionSaveAllFromSavedClient.setIcon(icon)
        self.actionSaveAllFromSavedClient.setObjectName("actionSaveAllFromSavedClient")
        ...
        self.menuOptions.addAction(self.actionSaveAllFromSavedClient)
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Ray Session"))
        self.toolButtonDuplicateSession.setText(_translate("MainWindow", "..."))
        self.toolButtonSaveTemplateSession.setToolTip(_translate("MainWindow", "<html><head/><body><p>Save Session as Template</p></body></html>"))
        self.toolButtonSaveTemplateSession.setText(_translate("MainWindow", "..."))
        ...
        self.actionSaveAllFromSavedClient.setText(_translate("MainWindow", "&Save All From Saved Client"))
        self.actionSaveAllFromSavedClient.setToolTip(_translate("MainWindow", "<html><head/><body><p>Some clients (Ardour, Qtractor...) sends their saved state to RaySession.</p><p>When this option is checked, the session is saved when a client sends that it has been saved.</p><p>For example, a Ctrl-S in Ardour will also save all the current Ray Session.</p></body></html>"))
...
from status_bar import StatusBarNegativ
import resources_rc
