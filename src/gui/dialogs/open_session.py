...
class SaveSessionTemplateDialog(SaveTemplateSessionDialog):
...
class DuplicateDialog(NewSessionDialog):
    def __init__(self, parent):
        super().__init__(parent, duplicate_window=True)
        self._server_will_accept = True
    ...
    def _add_sessions_to_list(self, session_names: list):
        super()._add_sessions_to_list(session_names)
