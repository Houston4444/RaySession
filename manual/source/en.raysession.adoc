...
[.text-right]
image:flags/en.jpeg[EN, 40, 30, link=XXX_LANG_SWITCH_en_XXX] image:flags/fr.jpeg[FR, 30, 20, link=XXX_LANG_SWITCH_fr_XXX] image:flags/de.jpeg[DE, 30, 20, link=XXX_LANG_SWITCH_de_XXX]

image::raysession.svg["icon", 100, 100]
_for version 0.13.1_
