...
Les scripts de session permettent de programmer des actions personnalisés à l'ouverture, à la sauvegarde et à la fermeture de la session. Éditer ces scripts nécessite des connaissances en script shell, ne perdez pas votre temps à lire cette section si vous n'y connaissez rien.
