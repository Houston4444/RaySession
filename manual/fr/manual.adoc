...
Vous allez maintenant afficher la baie de brassage de JACK. Pour celà, dans RaySession, appuyez sur *Contrôle* puis *Afficher la baie de brassage de JACK* (_ou Ctrl+J_). La baie de brassage est apparue sur la partie droite de la fenêtre.
...
[caption="Figure 1: ",link=images/exemple_patchbay.png]
image::exemple_patchbay.png[Baie de brassage de ma session]
...
Vous pouvez consultez le link:patchbay_manual.html[Manuel de la baie de brassage] pour apprendre à la maîtriser correctement.
...
Consultez le link:patchbay_manual.html[Manuel de la baie de brassage] pour mieux la maîtriser.
