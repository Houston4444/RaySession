...
[caption="Figure 1: ",link=../en/images/example_ardour_track.png]
...
link:../../patchbay/en/manual.html[Patchbay Manual]
...
Learn more about the patchbay in the link:../../patchbay/manual.html[Patchbay Manual].
...
[caption="Figure 1: ",link=../en/imagesages/audacity_save_file.png]
...
[caption="Figure 1: ",link=../en/imagesages/audacity_load_config_file.png]
